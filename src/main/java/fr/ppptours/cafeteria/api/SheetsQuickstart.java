...
public class SheetsQuickstart {
    ...
    public static Sheets buildService(String appName) throws IOException, GeneralSecurityException {
     ...
     */
    public static String createSpreadsheet(String title) throws GeneralSecurityException, IOException {
        final NetHttpTransport HTTP_TRANSPORT = GoogleNetHttpTransport.newTrustedTransport();

        Sheets service = buildService("CreationService");
    ...
    public static void main(String... args) throws IOException, GeneralSecurityException {
        ...
        System.out.println(createSpreadsheet("Test"));
    }
}
